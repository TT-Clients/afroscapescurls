                    ...
                    <div className="row">
                        <div className="col">
                            ...
                            <p style={{ overflow: 'auto', height: '300px' }}>
                                ...
                                be the catalyst for a book that records and documents the experience. <strong>June 8, 2024</strong>.
                            </p>
                        </div>
                        ...
                        <div className="col">
                            ...
                            <p style={{overflow:'auto', height:'200px'}}>
                                <strong>AfroCon</strong> is a day-long comic and gaming convention, with community conversations, workshops and vendors. It is a 1-2 day festival of nerd culture and black culture with artists, vendors, food trucks, workshops, demonstrations, gaming, cosplay and conference style community panels and conversations on a variety of topics from Black Representation in Media, drawing, writing and board game workshops, coding and Blacks in Technology. <strong>October 11-12, 2023</strong>.
                            </p>
                        </div>
                    </div>
                </div>
