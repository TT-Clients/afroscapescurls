    ...
    return (
        <header className="container-fluid header">           
             ...
             <div className="row d-flex justify-content-center">
                ...
                <div className="col-xs-12 col-sm-12 col-md-12 col-lg-4 d-flex justify-content-around">
                <img src="./img/HOACC.png" className="d-block img-fluid main-img" />
                </div>
                <div className="col-xs-12 col-sm-12 col-md-12 col-lg-7 d-flex justify-content-around">
