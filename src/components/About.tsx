            ...
            <div className="container">
                    ...
                    <div className="col">
                        <div className="text-center">
                            ...
                            <h3 className="section-subheading text-muted">
                                The House of Afros, Capes & Curls is an organization whose goal is to connect people from diverse backgrounds and build a
                                community based on a shared love of science fiction, fantasy, gaming, and Afrofuturism, while providing a safe space to explore
                ...
                <div className="row text-center">
                    ...
                    <div className="col-md-4">
                        ...
                        <p className="text-muted">
                            We create space for community members of all backgrounds to discuss sensitive issues using &quot;geek culture&quot; as the catalyst
